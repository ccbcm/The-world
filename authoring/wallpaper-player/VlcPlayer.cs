...
namespace Ccbcm {
 ...
 public sealed class VlcPlayer:Forms.Panel {
  ...
  IntPtr instance,player;DispatcherTimer poll;bool notified,wantsPause;Uri source;
  ...
  public void Close(){if(poll!=null)poll.Stop();if(player!=IntPtr.Zero){libvlc_media_player_stop(player);libvlc_media_player_set_media(player,IntPtr.Zero);}notified=false;}
